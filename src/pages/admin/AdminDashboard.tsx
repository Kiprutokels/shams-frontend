    ...
    <div className="min-h-screen bg-neutral-bg dark:bg-gray-950 p-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
        ...
        <div className="flex gap-3 mt-4 md:mt-0">
          <Button variant="outline" className="border-navy text-navy" onClick={() => navigate('/admin/analytics')}>
            <BarChart3 className="w-4 h-4 mr-2" />
            Analytics
          </Button>
          <Button variant="primary" className="bg-navy hover:opacity-90" onClick={() => navigate('/admin/users')}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            {[
              ...
              <div
                ...
                className={`flex justify-between items-center p-3 rounded-lg ${
                  item.highlight ? 'bg-navy/10' : 'bg-neutral-bg dark:bg-gray-900'
                }`}
              >
        ...
        <Card title="System Health">
          <div className="space-y-3">
            ...
            <div
              key={index}
              className="flex justify-between items-center p-3 bg-neutral-bg dark:bg-gray-900 rounded-lg"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            ...
            <button
              ...
              className="p-6 bg-white dark:bg-gray-900 border-2 border-gray-200 dark:border-gray-700 rounded-xl hover:border-navy hover:shadow-xl hover:-translate-y-1 transition-all text-center"
            >
              <div className="flex justify-center mb-4">
                <div className="p-4 bg-navy/20 rounded-xl">
                  <action.icon className="w-8 h-8 text-navy" />
                </div>
              </div>
